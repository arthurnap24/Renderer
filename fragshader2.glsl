...
//vec3 lightVecNormalized = normalize(vec3(0, 0, 5)); // this is where the light is located
...
void main()
{
  ...
  specModel[3] = 1.0;  
	...
	//out_frag_color = vec4(ambCoeff * ambient + (cosThetaDiff * lightColor) + specularPow, 1.0 );
  if (lightsOn == 1)
  {
